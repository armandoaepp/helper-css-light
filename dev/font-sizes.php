...
<head>
  ...
  $root = ROOT.DS;
    ...
    $setvar = array(
      'titulo'        => 'Font Sizes | Helper Css Light | Bootstrap4',
      'follow'        => '',
      'description'   => 'Font Sizes - helper css utilidades cs, utilidades bootstrap4 ',
      'keywords'      => 'Font Sizes, helper css, sass, scss,bootstrap4',
      'navbar_active' => [2,4]
    );
